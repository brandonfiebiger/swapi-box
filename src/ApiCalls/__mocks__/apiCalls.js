export const getHomeworld = jest.fn().mockImplementation(() => ({
  "name": "Stewjon",
...
export const getSingleSpecies = jest.fn().mockImplementation(() => ({
  "name": "Droid",
...
export const getResident = jest.fn().mockImplementation(() => ({
  "name": "Leia Organa",
  "height": "150",
  "mass": "49",
  "hair_color": "brown",
